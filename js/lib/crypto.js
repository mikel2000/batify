...
function hmac(message/* : Uint8Array */, key/* : Uint8Array */){
...
function getHKDF(ikm/* : Uint8Array */, info/* : Uint8Array */,
  extractLen, salt/* : Uint8Array */){
...
function getSeed(size/* : number */ = DEFAULT_SEED_SIZE) {
...
function deriveSigningKeysFromSeed(seed/* : Uint8Array */, salt/* : Uint8Array */) {
...
function uint8ToHex(arr/* : Uint8Array | Buffer */) {
